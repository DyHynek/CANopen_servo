...
// Servo node ID
  ...
  while (1)
  {
    /* USER CODE END WHILE */
//	  //canopen_app_process();
//	  //CO_PDO_running(&canopenNode_1, servoNodeId, 50000);

//	  Send_PDOPosition(&canopenNode_1, 0x300 + servoNodeId1, position);
//	  //Send_PDOPosition(&canopenNode_1, 0x300 + servoNodeId2, position);
//	  HAL_Delay(1);
//	  Send_PDOControlWord(&canopenNode_1, 0x200 + servoNodeId1, 0x4F);
//	  HAL_Delay(1);
//	  Send_PDOControlWord(&canopenNode_1, 0x200 + servoNodeId1, 0x5F);
//	  HAL_Delay(1);
//	  Send_PDOControlWord(&canopenNode_1, 0x200 + servoNodeId1, 0x4F);
	  //HAL_Delay(50);
//
